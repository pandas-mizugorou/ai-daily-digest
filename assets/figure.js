...
//
// スキーマ正規化 (フラット↔正準) は assets/figure-normalize.js に集約し、
// CI スクリプト (scripts/normalize-digest.mjs / validate-digest.mjs) と共有する。

import { normalizeFigureData } from "./figure-normalize.js";
